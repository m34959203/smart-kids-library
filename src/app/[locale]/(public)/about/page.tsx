...
export default async function AboutPage({
  ...
  const sections = [
    { title: t(messages, "about.mission"), text: t(messages, "about.missionText"), tag: "01" },
    {
      ...
      text: kk
        ? "Сәтбаев қаласының балалар-жасөспірімдер кітапханасы 2006 жылдың сәуірінде «Мәдени мұра» мемлекеттік бағдарламасы аясында құрылды. 2009 жылы күрделі жөндеу жұмыстары жүргізілді. 2026 жылы кітапхана Smart Kids Library жобасы аясында цифрлық трансформациядан өтті."
        : "Детско-юношеская библиотека города Сатпаев основана в апреле 2006 года в рамках государственной программы «Культурное наследие». В 2009 году проведены реконструкция и капитальный ремонт. В 2026 году библиотека прошла цифровую трансформацию в рамках проекта Smart Kids Library с ИИ-консультантом, голосовым диалогом и онлайн-каталогом.",
      tag: "02",
    },
  ];
